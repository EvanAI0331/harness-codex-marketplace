...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    DEFAULT_LLM_MODEL: env.DEFAULT_LLM_MODEL ?? env.LLM_MODEL ?? "",
    DEFAULT_LLM_BASE_URL: env.DEFAULT_LLM_BASE_URL ?? env.LLM_BASE_URL ?? "",
    DEFAULT_LLM_CREDENTIAL_REF: env.DEFAULT_LLM_CREDENTIAL_REF ?? env.LLM_CREDENTIAL_REF ?? "LLM_MAIN",
